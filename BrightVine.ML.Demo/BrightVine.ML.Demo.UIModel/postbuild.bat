xcopy "%~dp0htmlforms\*.*" "D:\Environments\BBCRM40SP30\APP\bbappfx\vroot\browser\htmlforms\" /e /y /r
xcopy "%~dp0bin\debug\BrightVine.ML.Demo.UIModel.DLL" "D:\Environments\BBCRM40SP30\APP\bbappfx\vroot\bin\custom\" /e /y /r
